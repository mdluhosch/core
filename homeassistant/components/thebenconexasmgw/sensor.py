...
from .coordinator import SmgwSensorCoordinator, ThebenConfData
...
class TotalInOutSensor(ConexaSMGWEntity, SensorEntity):
    ...
    def __init__(
        ...
        # As far as I know the Conexa 3.0 returns always Wh but there is the possibilty that it returns Joules
